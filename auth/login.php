...
<div class="flex flex-col md:flex-row min-h-screen w-full">
    ...
    <div class="hidden md:flex w-1/2 relative flex-col items-center justify-center min-h-screen">
        ...
        <a href="?page=landing" class="absolute top-10 left-10 text-white hover:text-gray-200 text-[15px] font-bold flex items-center gap-2 z-20 transition-all hover:-translate-x-1">
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center items-center p-8 lg:p-16 bg-white relative min-h-screen">
        ...
        <a href="?page=landing" class="md:hidden self-start text-gray-500 hover:text-citred text-[14px] font-bold flex items-center gap-1 mb-8 transition-colors">
        ...
        <div class="w-full max-w-[460px] bg-white p-10 rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100">
            ...
            <form id="login-form" action="?page=dashboard" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-3 gap-4 mb-8">
                    ...
                    <button type="button" id="btn-admin" class="role-btn bg-white text-gray-700 border border-gray-200 shadow-[0_2px_10px_rgba(0,0,0,0.04)] hover:bg-gray-50 py-4 rounded-xl flex flex-col items-center justify-center gap-2.5 transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-7 h-7">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c.98 0 1.81.622 2.122 1.5M19.5 10.5V9m0 1.5v1.5m-2.122-1.5A2.25 2.25 0 0119.5 12.75c-1.243 0-2.25-1.007-2.25-2.25s1.007-2.25 2.25-2.25z" />
                        </svg>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="email" placeholder="name@cit.edu" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-[15px] text-gray-900 placeholder-gray-400 focus:outline-none focus:border-citred focus:ring-2 focus:ring-citred/20 transition-all shadow-sm">
                    </div>
                    <div>
                        <label class="block text-[13px] font-bold text-gray-700 mb-2 uppercase tracking-wide">Password</label>
                        <input type="password" placeholder="••••••••" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-[15px] text-gray-900 placeholder-gray-400 focus:outline-none focus:border-citred focus:ring-2 focus:ring-citred/20 transition-all shadow-sm">
                    </div>
                </div>
                ...
                <div class="pt-4 flex flex-col gap-3.5">
                    ...
                    <a href="?page=guest" class="w-full block text-center bg-white border-2 border-gray-200 text-gray-800 font-bold py-3 rounded-lg shadow-sm text-[15px] hover:bg-gray-50 hover:border-gray-300 transition-all">
                        Continue as Guest
                    </a>
                </div>
            </form>
...
<script>
    ...
    function selectRole(roleValue, clickedBtn) {
        ...
        loginForm.action = roleValue === 'admin' ? '?page=admin' : '?page=dashboard';
        ...
        clickedBtn.classList.remove('hover:bg-gray-50'); 
