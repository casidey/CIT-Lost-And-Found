                    ...
                    <div class="space-y-5">
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p id="modalLocation" class="text-sm font-bold text-gray-900"></p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p id="modalDateTime" class="text-sm font-bold text-gray-900"></p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p id="modalReporter" class="text-sm font-bold text-gray-900"></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    // ── LOST item (someone else's) ───────────────────────────────────────────
        ...
        dynamicBox.innerHTML = item.contact_info
            ? `<div class="border border-gray-200 rounded-xl p-5 shadow-sm">
                   <p class="text-[10px] font-bold text-gray-400 uppercase mb-1">Reporter's Contact</p>
                   <p class="font-bold text-gray-900 text-sm">${item.contact_info}</p>
                   <p class="text-[11px] text-gray-400 mt-2">Reach out if you've found this item.</p>
               </div>`
            : `<div class="border border-gray-200 rounded-xl p-5 shadow-sm">
                   <p class="font-bold text-gray-700 text-sm mb-1">No contact info provided.</p>
